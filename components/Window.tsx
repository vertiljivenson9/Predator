...
export const Window = ({ state, onClose, onFocus, children }: any) => {
  ...
  return (
    <div onMouseDown={() => onFocus(state.id)} className="absolute bg-[#0a0a0a]/95 backdrop-blur-2xl border border-white/10 shadow-2xl rounded-2xl overflow-hidden flex flex-col pointer-events-auto"
